...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL,        KC_LALT, KC_LGUI, MT(MOD_LGUI, KC_LNG1), KC_SPC,  MT(MOD_LGUI,KC_MS_BTN3), KC_MS_BTN1, KC_MS_BTN2, KC_ENT,   LT(3, KC_LNG2),        KC_RGUI,   KC_RALT,   KC_LEFT,   KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT(
    ...
    [3] = LAYOUT(
        ...
        KC_LCTL,        KC_LALT, KC_LGUI, KC_LNG1,               KC_LNG2, MT(MOD_LGUI,KC_MS_BTN3), KC_MS_BTN1, KC_MS_BTN2, KC_0,     KC_DOT,                KC_RGUI,   KC_RALT,   KC_LEFT,   KC_DOWN,  KC_RGHT
    ),
    // clang-format on
};
